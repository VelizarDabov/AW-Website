...
if(loadedVideos=== totalVideos-1){
  ...
  return (
    <div className="relative h-dvh w-screen overflow-x-hidden">
      {isLoading && (<div className="flex-center absolute z-[100] h-dvh w-screen overflow-hidden bg-violer-50">
          ...
          <div className="mask-clip-path absolute-center absolute z-50 size-64 cursor-pointer overflow-hidden rounded-lg">
            ...
            >
              <video
                ...
                muted
                if="current-video"
                className="size-64 origin-center scale-100 object-cover object-center rounded-xl"
